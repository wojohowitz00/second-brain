...
Build with: pyinstaller scripts/SecondBrain.spec
"""
...
scripts_dir = os.path.join(os.path.dirname(os.path.abspath(SPEC)), '..', 'apps', 'backend', '_scripts')
sys.path.insert(0, scripts_dir)

block_cipher = None

entry_script = os.path.join('..', 'apps', 'backend', '_scripts', 'menu_bar_app.py')
