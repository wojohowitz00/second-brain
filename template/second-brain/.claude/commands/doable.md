...
1. Gather all open tasks (status ≠ done)
...
3. [ ] [task] — I'd [specific action]

## 🤝 Let's Do Together
1. [ ] [task] — I can help by [specific support: reviewing, analyzing, brainstorming]
2. [ ] [task] — I can help by [specific support]
