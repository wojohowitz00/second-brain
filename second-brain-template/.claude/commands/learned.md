...
### → _llm-context/writing/style-guide.md
**Add to "Phrases to Avoid":**
- "[phrase]" — [why to avoid]

### → _llm-context/business/audience.md
**Clarify:**
> [Current text]
→
> [Updated text]

### → .claude/claude.md (MCP Gotchas)
**Add:**
- [Service]: [gotcha discovered]
...
This command ensures the system gets smarter over time without requiring big upfront documentation efforts. Small learnings compound.
