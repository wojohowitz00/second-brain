...
```bash
cd /Applications/Second\ Brain.app/Contents/Resources/apps/backend/_scripts/
# Or for source install:
cd second-brain/apps/backend/_scripts/
...
- `apps/backend/_scripts/.env` — Slack credentials
- `apps/backend/_scripts/.state/` — Processing state
